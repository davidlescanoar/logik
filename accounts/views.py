...
from logik.tasks import validarCuentaCodeforces, validarCuentaOIAJ, actualizarCuentaCSES, actualizarCuentaSPOJ, actualizarCuentaOnlineJudge
import datetime 
...
def accounts(request):
    ...
    if request.method=='POST':
        ...
        actualizarCuentaOnlineJudge.apply_async((OnlineJudge_Handle_Input, request.user.id, request.user.username, fechaNow), countdown=364)
